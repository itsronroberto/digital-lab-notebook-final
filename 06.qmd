...
-   Axial ***Central skeleton: skull, vertebral column, ribs, and sternum.***
-   Appendicular skeleton ***Limbs and girdles that attach limbs to the axial skeleton.***

**General Structure of Long Bones** - See description in the textbook.

-   Epiphysis ***Expanded end of a long bone that forms joints.***
-   Diaphysis ***Shaft or long middle portion of a long bone.***
-   Compact bone ***Dense outer bone tissue that provides strength and support.***
-   Spongy bone ***Porous bone tissue with trabeculae that reduces weight and contains marrow.***
-   Hyaline (articular) cartilage ***Smooth cartilage covering bone ends to reduce friction.***
-   Periosteum ***Fibrous membrane covering the outer bone surface, except at joints.***
-   Bone processes ***Projections that serve as attachment points or joint surfaces.***
-   Medullary cavity ***Hollow cavity inside the diaphysis that contains marrow.***
-   Yellow marrow ***Fat-storing marrow found mainly in adult long bones.***
-   Red marrow ***Blood-cell-producing tissue found in spongy bone.***
-   Epiphyseal plate ***Hyaline cartilage growth plate where long bones grow in length.***
-   Endosteum (simple squamous) ***Thin membrane lining the medullary cavity and internal bone surfaces.***
...
| Matrix | ***Nonliving material around bone cells; made of collagen and mineral salts.*** |
| Collagen fibers | ***Protein fibers that give bone flexibility and tensile strength.*** |
| Calcium phosphate | ***Mineral salt that hardens bone and gives compressive strength.*** |
| Osteoblasts | ***Bone-forming cells that build new matrix.*** |
| Osteoclasts | ***Cells that break down and resorb bone.*** |

**Bone Classification:**

| Term | Definition |
|-----------------------------------------|-------------------------------|
| Long bonos | ***Bones longer than wide; act as levers for movement.*** |
| Long bones | ***Bones longer than wide, such as femur or humerus.*** |
| Short bones | ***Cube-shaped bones that provide stability with limited movement.*** |
| Flat bones | ***Thin, flat bones that protect organs and provide muscle attachment.*** |
| Irregular | ***Bones with complex shapes that do not fit other categories.*** |
| Sesamoid bones | ***Small round bones embedded in tendons that reduce friction.*** |
...
|--------|-----------------------------|-----------------------------|
| 1      | ***Spinal Column***         | ***Axial***                 |
| 2      | ***Cervical Vertebrae***    | ***Axial***                 |
| 3      | ***Thoracic Vertebrae***    | ***Axial***                 |
| 4      | ***Lumbar Vertebrae***      | ***Axial***                 |
| 5      | ***Sacrum***                | ***Axial***                 |
| 6      | ***Coccyx***                | ***Axial***                 |
| 7      | ***Skull***                 | ***Axial***                 |
| 8      | ***Cranium***               | ***Axial***                 |
| 9      | ***Figure label required*** | ***Figure label required*** |
| 10     | ***Figure label required*** | ***Figure label required*** |
| 11     | ***Figure label required*** | ***Figure label required*** |
| 12     | ***Figure label required*** | ***Figure label required*** |
| 13     | ***Figure label required*** | ***Figure label required*** |
| 14     | ***Figure label required*** | ***Figure label required*** |
| 15     | ***Figure label required*** | ***Figure label required*** |
| 16     | ***Figure label required*** | ***Figure label required*** |
| 17     | ***Figure label required*** | ***Figure label required*** |
| 18     | ***Figure label required*** | ***Figure label required*** |
| 19     | ***Figure label required*** | ***Figure label required*** |
| 20     | ***Figure label required*** | ***Figure label required*** |
| 21     | ***Figure label required*** | ***Figure label required*** |
| 22     | ***Figure label required*** | ***Figure label required*** |
| 23     | ***Figure label required*** | ***Figure label required*** |
| 26     | ***Figure label required*** | ***Figure label required*** |
...
| Short | Cube shaped length, width, and thickness; relatively equal | ***Carpals; tarsals*** |
| Flat | Thin and wide curved | ***Sternum; ribs; cranial bones*** |
| Irregular | Complex shape | ***Vertebrae; hip bones*** |
| Sesamoid | Seed shaped small and round | ***Patella; pisiform*** |
...
-   What are the major anatomical differences between spongy and compact bone?
    ...
    ***Compact bone is dense and forms the strong outer layer of bone. Spongy bone is porous, contains trabeculae and marrow spaces, and is usually found inside epiphyses and flat bones.***
...
**7** Blood vessels and nerves may move from one Haversian canal to another by detouring through a(n) ***perforating canal***. (11,5)
...
|------------------------|------------------------|------------------------|
| ***d*** | ***Articular*** cartilage covers ends of long bones. | a\) axial |
| ***e*** | Skeletal cartilage is enclosed by the ***perichondrium***. | b\) hyaline cartilage |
| ***h*** | The bones of the limbs, shoulders, and hips make up the ***appendicular*** skeleton. | c\) epiphyseal line |
| ***i*** | Cancellous bone is found in the ***epiphyses*** of long bones. | d\) Articular |
| ***g*** | ***Yellow marrow*** is found in the central (medullary) cavity of an adult's long bones and is composed of fat. | e\) perichondrium |
| ***b*** | Articular cartilage is composed of ***hyaline cartilage***. | f\) diaphysis; |
| ***j*** | The inner surface of the bone, where it meets the marrow, is covered by a delicate membrane called the ***endosteum***. | g\) Yellow marrow |
| ***f*** | The tubular shaft that forms the axis of long bones is called the ***diaphysis***. | h\) appendicular |
| ***a*** | The bones of the skull, rib cage, and vertebral column make up the ***axial*** skeleton | i\) epiphyses |
| ***c*** | The line that separates the diaphysis from the epiphysis in a long bone is called the ***epiphyseal line***. | j\) endosteum |
