...
+----------------------------------+--------------------------------------------------------------+
| Superior (or cranial)            | ***Toward the head or upper part of the body.***             |
+----------------------------------+--------------------------------------------------------------+
| Inferior (or caudal)             | ***Away from the head; toward the lower part of the body.*** |
+----------------------------------+--------------------------------------------------------------+
...
+----------------------------------+--------------------------------------------------------------+
| Deep                             | ***Farther from the body surface; more internal.***          |
+----------------------------------+--------------------------------------------------------------+
...
| Term                             | Definition                                                                                    |
+==================================+===============================================================================================+
| Cranial                          | ***Cavity inside the skull that contains the brain.***                                        |
+----------------------------------+-----------------------------------------------------------------------------------------------+
| Abdominal                        | ***Cavity that contains many digestive organs, such as the stomach, liver, and intestines.*** |
+----------------------------------+-----------------------------------------------------------------------------------------------+
| Pericardial                      | ***Cavity surrounding the heart.***                                                           |
+----------------------------------+-----------------------------------------------------------------------------------------------+
| Pleural                          | ***Cavity surrounding each lung.***                                                           |
+----------------------------------+-----------------------------------------------------------------------------------------------+
| Ventral                          | ***Anterior body cavity that includes the thoracic and abdominopelvic cavities.***            |
+----------------------------------+-----------------------------------------------------------------------------------------------+
...
+==================================+===================================================================================+===========================================================================+
| 1 - Integumentary system         | ***Protects the body, helps regulate temperature, and prevents water loss.***     | ***Skin, hair, nails, sweat glands, oil glands***                         |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 2 - Skeletal system              | ***Supports the body, protects organs, stores minerals, and makes blood cells.*** | ***Bones, cartilage, ligaments, joints***                                 |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 3 - Muscular system              | ***Produces movement, maintains posture, and produces heat.***                    | ***Skeletal muscles and tendons***                                        |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 4 - Nervous system               | ***Controls rapid responses and detects changes inside and outside the body.***   | ***Brain, spinal cord, nerves, sensory receptors***                       |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 5 - Endocrine system             | ***Releases hormones that regulate body processes.***                             | ***Pituitary, thyroid, adrenal glands, pancreas, ovaries/testes***        |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 6 - Cardiovascular system        | ***Transports blood, oxygen, nutrients, hormones, and wastes.***                  | ***Heart, blood, blood vessels***                                         |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 7 - Lymphatic/immune system      | ***Returns fluid to blood and helps defend against disease.***                    | ***Lymph nodes, lymph vessels, spleen, thymus, tonsils***                 |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 8 - Respiratory system           | ***Brings in oxygen and removes carbon dioxide.***                                | ***Lungs, trachea, bronchi, nasal cavity, pharynx, larynx***              |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 9 - Digestive system             | ***Breaks down food, absorbs nutrients, and eliminates solid waste.***            | ***Mouth, esophagus, stomach, intestines, liver, pancreas, gallbladder*** |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 10 - Urinary system              | ***Removes nitrogenous wastes and regulates water, salts, and pH.***              | ***Kidneys, ureters, urinary bladder, urethra***                          |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 11a - Male reproductive system   | ***Produces sperm and male sex hormones.***                                       | ***Testes, epididymis, vas deferens, prostate, penis***                   |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
| 11b - Female reproductive system | ***Produces eggs and female sex hormones; supports pregnancy.***                  | ***Ovaries, uterine tubes, uterus, vagina, mammary glands***              |
+----------------------------------+-----------------------------------------------------------------------------------+---------------------------------------------------------------------------+
...
***Standing upright, facing forward, feet flat and forward, arms at the sides, and palms facing forward.***
...
***Label superior/cranial toward the head, inferior/caudal toward the feet, anterior/ventral toward the front, posterior/dorsal toward the back, medial toward the midline, lateral away from the midline, proximal closer to the trunk, distal farther from the trunk, right on the subject's right side, and left on the subject's left side.***
...
***Superficial: closer to the skin/scalp. Deep: closer to the brain/internal structures.***
...
+----------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 5                                | A papercut that does not penetrate the skin would be considered as a ***superficial*** wound; however, a puncture wound from a nail penetrating the skin would be considered as a ***deep*** wound. |
+----------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+================================================================================================================================================================================+===================================+==========================================================================================================================================================================================================================================================================+
| Example: Standing from a Half Spinal Twist with the feet placed to the left, the torso twisted away from you and the head facing at a slight angle to the right, away from you | ![Figure 1.6](images/fig1.6.jpeg) | Example:<br><br>- Rotate the mental region anteriorly and medially.<br><br>- Rotate the entire body 180 degrees to the left.<br><br>- Position palmar region anteriorly                                                                                                  |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 1: From lying face-up on the ground with their head, back, hands, and feet on the floor with both knees bent                                                                   | ![Figure 1.7](images/fig1.7.jpeg) | ***Extend the knees so the lower limbs are straight.***<br><br>***Move the body from supine to standing upright.***<br><br>***Place the feet flat and facing anteriorly.***<br><br>***Place the upper limbs at the sides with the palmar regions facing anteriorly.***   |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2: From a seated position on the floor with their legs straight and arms folded across their chest                                                                             | ![Figure 1.8](images/fig1.8.jpeg) | ***Move the body from seated to standing upright.***<br><br>***Keep the head and eyes facing anteriorly.***<br><br>***Move the upper limbs from the thoracic region to the sides of the body.***<br><br>***Rotate the forearms so the palmar regions face anteriorly.*** |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
***Label the midsagittal plane through the midline, the sagittal/parasagittal planes as left-right divisions, the coronal/frontal plane as the anterior-posterior division, the transverse plane as the superior-inferior division, and the oblique plane as an angled cut through the right brachial region.***
...
| Quadrants                        | Organs                                                                    |
+==================================+===========================================================================+
| Right upper quadrant             | ***Liver, gallbladder, right kidney, small intestine***                   |
+----------------------------------+---------------------------------------------------------------------------+
| Right lower quadrant             | ***Cecum, appendix, right ovary/testis region, small intestine***         |
+----------------------------------+---------------------------------------------------------------------------+
| Left upper quadrant              | ***Stomach, spleen, left kidney, pancreas***                              |
+----------------------------------+---------------------------------------------------------------------------+
| Left lower quadrant              | ***Descending/sigmoid colon, left ovary/testis region, small intestine*** |
+----------------------------------+---------------------------------------------------------------------------+
...
| Regions                          | Organs                                                      |
+==================================+=============================================================+
| left hypochondriac               | ***Spleen, left kidney, stomach***                          |
+----------------------------------+-------------------------------------------------------------+
...
+----------------------------------+-------------------------------------------------------------+
| left iliac                       | ***Sigmoid colon, left ovary/uterine tube***                |
+----------------------------------+-------------------------------------------------------------+
| hypogastric                      | ***Urinary bladder, small intestine, reproductive organs*** |
+----------------------------------+-------------------------------------------------------------+
| right iliac                      | ***Cecum, appendix, right ovary/uterine tube***             |
+----------------------------------+-------------------------------------------------------------+
...
| Organ System                     | Organs                                                                    |
+==================================+===========================================================================+
| 1 - Integumentary system         | ***Skin, hair, nails, sweat glands, oil glands***                         |
+----------------------------------+---------------------------------------------------------------------------+
| 2 - Skeletal system              | ***Bones, cartilage, ligaments, joints***                                 |
+----------------------------------+---------------------------------------------------------------------------+
| 3 - Muscular system              | ***Skeletal muscles and tendons***                                        |
+----------------------------------+---------------------------------------------------------------------------+
| 4 - Nervous system               | ***Brain, spinal cord, nerves, sensory receptors***                       |
+----------------------------------+---------------------------------------------------------------------------+
| 5 - Endocrine system             | ***Pituitary, thyroid, adrenal glands, pancreas, ovaries/testes***        |
+----------------------------------+---------------------------------------------------------------------------+
| 6 - Cardiovascular system        | ***Heart, blood, blood vessels***                                         |
+----------------------------------+---------------------------------------------------------------------------+
| 7 - Lymphatic/immune system      | ***Lymph nodes, lymph vessels, spleen, thymus, tonsils***                 |
+----------------------------------+---------------------------------------------------------------------------+
| 8 - Respiratory system           | ***Lungs, trachea, bronchi, nasal cavity, pharynx, larynx***              |
+----------------------------------+---------------------------------------------------------------------------+
| 9 - Digestive system             | ***Mouth, esophagus, stomach, intestines, liver, pancreas, gallbladder*** |
+----------------------------------+---------------------------------------------------------------------------+
| 10 - Urinary system              | ***Kidneys, ureters, urinary bladder, urethra***                          |
+----------------------------------+---------------------------------------------------------------------------+
| 11a - Male reproductive system   | ***Testes, epididymis, vas deferens, prostate, penis***                   |
+----------------------------------+---------------------------------------------------------------------------+
| 11b - Female reproductive system | ***Ovaries, uterine tubes, uterus, vagina, mammary glands***              |
+----------------------------------+---------------------------------------------------------------------------+
...
-   The lips are ***anterior*** and ***medial*** to the ears.
-   The brain is ***deep*** to the skull.
-   The thighs are ***superior*** to the feet.
...
-   "Acromial" refers to the ***shoulder point***.
...
-   The ***frontal*** or ***coronal*** plane separates the anterior and posterior portions of an object
-   The ***transverse*** or ***horizontal*** plane separates the superior and inferior portions of an object.

### Cavities

-   The cranial cavity is within the ***dorsal*** cavity.
-   The spinal or vertebral cavity is within the ***dorsal*** cavity.
-   The thoracic cavity is within the ***ventral*** cavity.
-   The abdominopelvic cavity is within the ***ventral*** cavity.
-   The brain is found in the ***cranial*** cavity. Use the most specific, i.e., smallest cavity that is appropriate.
-   The spinal cord is found in the ***vertebral/spinal*** cavity. Use the most specific, i.e., smallest cavity that is appropriate.
...
-   **2** Is affected by the removal of the thyroid gland (9): ***Endocrine***
-   **6** Includes the heart (14): ***Cardiovascular***
-   **8** Protects underlying organs from drying out and mechanical damage (13): ***Integumentary***
-   **10** Moves the limbs (8): ***Muscular***

### **Down**

-   **1** Provides for conception and childbearing (12): ***Reproductive***
-   **3** Brain, nerves, sensory receptors (7): ***Nervous***
-   **4** Rids the body of nitrogen-containing wastes (7): ***Urinary***
-   **5** Breaks down food into small particles that can be absorbed (9): ***Digestive***
-   **7** Provides support and levers on which the muscular system can act (8): ***Skeletal***
-   **9** Provides oxygen into the blood (11): ***Respiratory***
...
-   **4** Cavity surrounded by the rib cage, bounded inferiorly by the diaphragm. (8): ***Thoracic***
-   **5** Cavities lateral to the heart which contain the lungs (7): ***Pleural***

### **Down**

-   **1** Medial portion of the thoracic cavity; consists of heart, thymus gland, trachea, and blood vessels (11): ***Mediastinum***
-   **2** Small space enclosed by the pelvic bones. (6): ***Pelvic***
-   **3** Cavity bounded by the abdominal muscles (9): ***Abdominal***
