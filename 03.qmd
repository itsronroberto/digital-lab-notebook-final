...
| Term | Definition |
|---------------------------|---------------------------------------------|
| Cytoplasm | ***All material inside the cell membrane except the nucleus.*** |
...
| Term | Definition |
|--------------------------|---------------------------------------------|
| Rough Endoplasmic Reticulum | ***Membrane network with ribosomes that makes and folds proteins.*** |
| Smooth Endoplasmic reticulum | ***Membrane network that makes lipids, detoxifies substances, and stores calcium.*** |
| Golgi apparatus | ***Modifies, sorts, and packages proteins and lipids for transport.*** |
| Mitochondrion | ***Produces ATP energy through cellular respiration.*** |
| Lysosomes | ***Digest worn-out organelles, wastes, and large molecules.*** |
| Peroxisomes | ***Break down fatty acids and detoxify harmful hydrogen peroxide.*** |
| Microfilaments | ***Thin cytoskeleton fibers that support cell shape and movement.*** |
| Microtubules | ***Thick cytoskeleton fibers that help with cell shape, transport, and division.*** |
| Cilia | ***Short hairlike projections that move substances across the cell surface.*** |
| Flagella | ***Long tail-like projection that moves the cell.*** |
| Nucleus | ***Contains DNA and controls cell activities.*** |
| Nucleolus | ***Makes ribosomal RNA and assembles ribosome parts.*** |
...
-   Interphase: ***The stage when a cell grows, performs normal functions, and copies DNA.***
-   Mitosis: ***Division of the nucleus that produces two identical nuclei.***

### **Stages of Interphase and Mitosis**

-   Interphase: ***Period of growth and DNA replication before mitosis.***
...
|----------------------|-----------------|---------------------------------|
| Prophase | ***Chromatin condenses into chromosomes, the nuclear envelope breaks down, and spindle fibers form.*** | ***Chromosomes become visible and the nucleus starts disappearing.*** |
| Metaphase | ***Chromosomes line up at the center of the cell.*** | ***Chromosomes appear in a straight line across the middle.*** |
| Anaphase | ***Sister chromatids separate and move to opposite poles.*** | ***Chromatids look pulled apart toward opposite ends.*** |
| Telophase | ***New nuclear envelopes form around each set of chromosomes.*** | ***Two new nuclei appear and chromosomes begin to loosen.*** |
| Cytokinesis | ***The cytoplasm divides to form two daughter cells.*** | ***The cell pinches into two separate cells.*** |
...
| c   | ***Glycolipid***                       |
| d   | ***Cholesterol***                      |
| e   | ***Integral protein/channel protein*** |
...
-   Interphase: ***Cell growth and DNA replication before M-phase.***
-   M-phase: ***The mitotic phase when the cell divides its nucleus and cytoplasm.***
-   Chromosome: ***A condensed DNA-protein structure that carries genetic information during cell division.***
-   Chromatin: ***Loose DNA and protein material found in the nucleus when the cell is not dividing.***
...
-   What are the primary macromolecules that make up the membrane? ***Lipids, proteins, and carbohydrates.***
-   What are the functions of the following components:
    -   Phospholipids: ***Form the bilayer barrier of the membrane.***
    -   Cholesterol: ***Stabilizes the membrane and helps control fluidity.***
    -   Proteins: ***Help with transport, signaling, recognition, and support.***
...
|---------------------------------|------------------|----------------------|
| Plasma membrane | ***Lab model number required*** | ***Controls what enters and leaves the cell.*** |
| Cilia | ***Lab model number required*** | ***Move substances across the cell surface.*** |
| Microvilli | ***Lab model number required*** | ***Increase surface area for absorption.*** |
| Nucleolus | ***Lab model number required*** | ***Produces ribosome components.*** |
| Nucleus | ***Lab model number required*** | ***Contains DNA and controls cell activity.*** |
| Nuclear envelope | ***Lab model number required*** | ***Double membrane that surrounds and protects the nucleus.*** |
| Nuclear pore | ***Lab model number required*** | ***Allows materials to pass between nucleus and cytoplasm.*** |
| Ribosome | ***Lab model number required*** | ***Site of protein synthesis.*** |
| Vesicle | ***Lab model number required*** | ***Transports or stores materials in the cell.*** |
| Peroxisome | ***Lab model number required*** | ***Breaks down fatty acids and detoxifies peroxide.*** |
| Lysosome | ***Lab model number required*** | ***Digests wastes and worn-out cell parts.*** |
| Golgi apparatus | ***Lab model number required*** | ***Modifies, sorts, and packages proteins and lipids.*** |
| Mitochondrion | ***Lab model number required*** | ***Produces ATP energy.*** |
| Rough endoplasmic reticulum | ***Lab model number required*** | ***Makes and folds proteins.*** |
| Smooth endoplasmic reticulum | ***Lab model number required*** | ***Makes lipids and detoxifies substances.*** |
| Centriole | ***Lab model number required*** | ***Organizes spindle fibers during cell division.*** |
...
4.  The basic structure of a cell's membrane is a(n) ***phospholipid*** bilayer with associated proteins that can be either ***integral*** or ***peripheral***.

## **Post Lab Activity 3.2**

**Multiple choice questions:**

1.  Because they are embedded within the membrane, ion channels are examples of ***b) integral proteins***.
    a)  receptor proteins
    b)  integral proteins
    c)  peripheral proteins
    d)  glycoproteins
2.  Which of the following structures could be found within the nucleolus? ***c) ribosomes***.
    a)  chromatin
    b)  histones
    c)  ribosomes
    d)  nucleosomes
3.  Choose the term that best completes the following analogy: Cytoplasm is to cytosol as a swimming pool containing chlorine and flotation toys is to ***d) the water***.
    a)  the walls of the pool
    b)  the chlorine
    c)  the flotation toys
    d)  the water
4.  The rough ER has its name due to what associated structures? ***b) ribosomes***.
    a)  Golgi apparatus
    b)  ribosomes
    c)  lysosomes
    d)  proteins
5.  Which of the following is a function of the rough ER? ***a) production of proteins***.
...
6.  Which of the following organelles produces large quantities of ATP when both glucose and oxygen are available to the cell? ***a) mitochondria***.
    a)  mitochondria
    b)  peroxisomes
    c)  lysosomes
    d)  ER
7.  Which of the following phases is characterized by preparation for DNA synthesis? ***b) G1***.
    a)  G0
    b)  G1
    c)  G2
    d)  S
...
| 3      | ***Nucleolus***                       |
| 4a     | ***Chromatin***                       |
| 4b     | ***Chromosome/condensed chromatin***  |
| 5      | ***Nucleoplasm***                     |
