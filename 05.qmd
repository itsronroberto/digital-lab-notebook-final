...
|-----------------------|-----------------------|
| Pore                  | ***Figure label required*** |
| Arrector pili muscle  | ***Figure label required*** |
| Meissner's corpuscle  | ***Figure label required*** |
| Pacinian corpuscle    | ***Figure label required*** |
| Keratinocyte          | ***Figure label required*** |
| Apocrine sweat gland  | ***Figure label required*** |
| Hair follicle         | ***Figure label required*** |
| Dermal papillae       | ***Figure label required*** |
| Merocrine sweat gland | ***Figure label required*** |
| Hair root             | ***Figure label required*** |
| Sebaceous gland       | ***Figure label required*** |
| Free nerve ending     | ***Figure label required*** |
| Hair shaft            | ***Figure label required*** |
